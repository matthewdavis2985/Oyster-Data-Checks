...
SedimentTrap_nulls <- filter(SedimentTrap1, is.na(CupSampleID) | is.na(SampleEventID) | is.na(DeployedDate)) %>%
  select(CupSampleID, SampleEventID, DeployedDate, Comments)
