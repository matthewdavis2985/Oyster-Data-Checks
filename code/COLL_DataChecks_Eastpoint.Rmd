...
# Set your variables
CheckStart <- as.Date("2024-09-01")  # Start Date for Checks
CheckEnd <- as.Date("2024-09-30")  # End Date for Checks
EstuaryCode = "AB"  # Estuary Code. Use 2-letter code in Primary Keys
DataManager = "Matthew Davis"
Database = "OysterLocalMD20250804"
...
DO_range <- SampleEventWQ1 %>% 
  mutate(DO.Sat = convert_DO(DissolvedOxygen, from = "mg/L", to = "%Air", S = Salinity, t = Temperature) / 100) %>%
