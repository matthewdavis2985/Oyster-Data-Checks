...
null_CI <- filter(CI1, is.na(ShellHeight), is.na(ShellLength), is.na(ShellWidth), is.na(TotalWeight), is.na(TarePanWeight), is.na(TissueWetWeight), is.na(ShellWetWeight), is.na(TissueDryWeight), is.na(ShellDryWeight)) %>%
  ...
  # Out of range values
CI_range1 <- filter(CI1, ShellHeight < 10 | ShellHeight > 150 | ShellLength < 20 | ShellLength > 90 | ShellLength > ShellHeight | ShellWidth < 8 | ShellWidth > 50 | ShellWidth > ShellLength | TotalWeight < 10 | TotalWeight > 250) %>%
...
CI_range2 <- filter(CI1, TarePanWeight < 0.9 | TarePanWeight > 5 | TissueWetWeight < ((TotalWeight + TarePanWeight) * 0.05) | TissueWetWeight > ((TotalWeight + TarePanWeight) * 0.4) | ShellWetWeight < (TotalWeight * 0.5) | ShellWetWeight > (TotalWeight * 0.99) | TissueDryWeight < TarePanWeight | TissueDryWeight > (TissueWetWeight * 0.9) | ShellDryWeight < (ShellWetWeight * 0.8) | ShellDryWeight > ShellWetWeight) %>%
  select(OysterID, TotalWeight, TarePanWeight, TissueWetWeight, ShellWetWeight, TissueDryWeight, ShellDryWeight, Comments)
...
null_Dermo <- filter(Dermo1, is.na(ShellHeight), is.na(ShellLength), is.na(ShellWidth), is.na(TotalWeight), is.na(ShellWetWeight), is.na(DermoMantle), is.na(DermoGill)) %>%
  ...
  # Out of range values
Dermo_range <- filter(Dermo1, ShellHeight < 10 | ShellHeight > 150 | ShellLength < 20 | ShellLength > 90 | ShellLength > ShellHeight | ShellWidth < 8 | ShellWidth > 50 | ShellWidth > ShellLength | TotalWeight < 10 | TotalWeight > 250 | DermoMantle < 0 | DermoMantle > 5 | DermoGill < 0 | DermoGill > 5) %>%
  select(OysterID, ShellHeight, ShellLength, ShellWidth, TotalWeight, DermoMantle, DermoGill, Comments)
