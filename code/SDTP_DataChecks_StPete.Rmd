...
Dry_ranges <- filter(SedimentTrap1, FilterDryWeight < FilterTareWeight | FilterDryWeight > 12 | PanDryWeight < PanTareWeight | PanDryWeight > 600) %>%
...
`r if (nrow(Dry_ranges) > 0) {kable(Dry_ranges, caption = "Out of range Dry data. Expected range for dry filters is FilterTare to 12.00 grams. Expected range for dry pans is PanTare to 600.00 grams. Comment required for out of range values.")}`
