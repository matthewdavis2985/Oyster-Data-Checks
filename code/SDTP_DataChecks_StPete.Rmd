...
Tare_ranges <- filter(SedimentTrap1, FilterTareWeight < 0 | FilterTareWeight > 3.00 | PanTareWeight < 0 | PanTareWeight > 400.00) %>%
...
Biota_ranges <- filter(SedimentTrap1, NumDrills < 0 | NumDrills > 8 | NumCrabs < 0 | NumCrabs > 5 | NumHermitCrabs < 0 | NumHermitCrabs > 30 | NumFish < 0 | NumFish > 3 | NumOtherBiota < 0 | NumOtherBiota > 10) %>%
...
`r if (nrow(Tare_ranges) > 0) {kable(Tare_ranges, caption = "Out of range Tare data. Expected range for filters is 0 to 3.00 grams. Expected range for pans is 0 to 400.00 grams. Comment required for out of range values.")}`
...
`r if (nrow(Biota_ranges) > 0) {kable(Biota_ranges, caption = "Out of range Biota data. Expected range for Drills is 0 to 8. Expected range for Crabs is 0 to 5. Expected range for Hermit Crabs is 0 to 30. Expected range for Fish is 0 to 3. Expected range for OtherBiota is 0 to 10. Comment required for out of range values.")}`
