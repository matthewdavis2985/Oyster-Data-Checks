...
CheckEnd <- as.Date("2024-04-30")  # End Date for Checks
DataManager = "Erica Levine"
Database = "Oysters_24-10-31"
Server = "localhost\\ERICALOCALSQL"

EstuaryCode = c("SL")  #params$[project] or use 2-letter code in Primary Keys for single estuary
