...
FixedLocations1 <- dboFixedLocations %>% 
  ...
  select(FixedLocationID, Estuary, SectionName, StationNumber, ParcelName, FixedLat, FixedLon) %>% 
  distinct()
...
SampleEvent1 <- dboSampleEvent %>% 
  ...
  arrange(TripDate, StationNumber, ParcelName)
...
SampleEventWQ1 <- dboSampleEventWQ %>% 
  ...
  arrange(TripDate, StationNumber, ParcelName, SampleEventWQID)
...
ShellBudgetQuadrat1 <- dboShellBudgetQuadrat %>% 
  ...
  arrange(TripDate, StationNumber, ParcelName, QuadratID)
...
ShellBudgetSH1 <- dboShellBudgetSH %>% 
  ...
  left_join(FixedLocations1, ShellBudgetQuadrat1, by = c("FixedLocationID")) %>%
  arrange(TripDate, StationNumber, ParcelName, ShellHeightID)
