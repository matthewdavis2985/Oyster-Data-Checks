...
EstuaryCode = params$EAST  #params$Sites for multiple or use 2-letter code in Primary Keys for single
...
null_SurveyQuads <- if(any(EstuaryCode %in% c("SL", "LX", "LW"))) {
  ...
  # Out of range values
SurveyQuad_range <- if(any(EstuaryCode %in% c("SL", "LX", "LW"))) {
...
if(any(EstuaryCode %in% c("SL", "LX", "LW"))){
