...
EXEC sp_CompleteCollections_hsdb \'`r EstuaryCode`\', \'`r CheckStart`\',
...
INSERT INTO #ValidTrips (TripID) SELECT TripID FROM hsdb.TripInfo WHERE
TripDate \> \'`r CheckStart`\' AND TripDate \< \'`r CheckEnd`\' AND
DataStatus = \'Proofed\' AND TripID like \'`r EstuaryCode`SRVY%\';

UPDATE hsdb.TripInfo SET DataStatus = \'Completed\', CompletedBy =
\'`r DataManager`\', DateCompleted = \'`r format(Sys.Date(), "%d-%B-%Y")`\'
WHERE TripID IN (SELECT TripID FROM #ValidTrips);

UPDATE hsdb.SampleEvent SET DataStatus = \'Completed\', CompletedBy =
\'`r DataManager`\', DateCompleted = \'`r format(Sys.Date(), "%d.%B.%Y")`\'
WHERE TripID IN (SELECT TripID FROM #ValidTrips);

UPDATE hsdb.SampleEventWQ SET DataStatus = \'Completed\', CompletedBy =
\'`r DataManager`\', DateCompleted = \'`r format(Sys.Date(), "%d-%B-%Y")`\'
WHERE SampleEventID IN (SELECT SampleEventID FROM SampleEvent WHERE
TripID IN (SELECT TripID FROM #ValidTrips));

UPDATE hsdb.ConditionIndex SET DataStatus = \'Completed\', CompletedBy =
\'`r DataManager`\', DateCompleted = \'`r format(Sys.Date(), "%d-%B-%Y")`\'
WHERE SampleEventID IN (SELECT SampleEventID FROM SampleEvent WHERE
TripID IN (SELECT TripID FROM #ValidTrips));

UPDATE hsdb.Dermo SET DataStatus = \'Completed\', CompletedBy =
\'`r DataManager`\', DateCompleted = \'`r format(Sys.Date(), "%d-%B-%Y")`\'
WHERE SampleEventID IN (SELECT SampleEventID FROM SampleEvent WHERE
TripID IN (SELECT TripID FROM #ValidTrips));

UPDATE hsdb.Repro SET DataStatus = \'Completed\', CompletedBy =
\'`r DataManager`\', DateCompleted = \'`r format(Sys.Date(), "%d-%B-%Y")`\'
WHERE SampleEventID IN (SELECT SampleEventID FROM SampleEvent WHERE
TripID IN (SELECT TripID FROM #ValidTrips));
