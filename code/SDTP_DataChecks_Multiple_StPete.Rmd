...
CheckEnd <- as.Date("2024-03-30")  # End Date for Checks
...
TripInfo1 <- dboTripInfo %>% 
  filter(substring(TripID,1,2) %in% EstuaryCode & TripDate >= CheckStart & TripDate <= CheckEnd & TripType == "Sediment Trap" & DataStatus == "Proofed") %>%
  arrange(TripID)
