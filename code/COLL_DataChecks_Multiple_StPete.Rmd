...
# Set your variables
CheckStart <- as.Date("2024-08-01")  # Start Date for Checks
CheckEnd <- as.Date("2024-08-31")  # End Date for Checks
EstuaryCode = "SL"  # Estuary Code. Use 2-letter code in Primary Keys
DataManager = "Erica Levine"
Database = "Oysters_24-08-28"
...
`r if (nrow(ERR_Table3) > 0) {kable(ERR_Table3, caption = "Childless Primary Keys. Primary Keys MUST have at least one child record! SampleEvents must have 15 child records unless a valid comment is present. *Primary keys will be Childless until data is proofed or if there is no data entered.*")}`
