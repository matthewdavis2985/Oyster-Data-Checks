...
# Set your variables
CheckStart <- as.Date("2026-05-01")  # Start Date for Checks
CheckEnd <- as.Date("2026-05-28")  # End Date for Checks
DataManager = "Erica Williams"
Database = "Oysters_26-06-01"
Server = "localhost\\ERICALOCALSQL"

EstuaryCode = c(params$PBC)  #params$[project] or use 2-letter code in Primary Keys for single estuary
